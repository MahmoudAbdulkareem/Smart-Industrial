...
const SEV = {
    ...
    caution:  { bg: "#fffbeb", border: "#fde68a", text: "#b45309", left: "#f59e0b" },
    info:     { bg: "#eff6ff", border: "#bfdbfe", text: "#1e40af", left: "#3b82f6" },
};
        ...
        <div>
                                ...
                                <div key={alert.id} style={{ background: s.bg, border: "1px solid " + s.border, borderLeft: "4px solid " + s.left, borderRadius: 9, padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                                    ...
                                    {canAck && (
                                        <button onClick={() => handleAck(alert.id)}
                                            style={{ padding: "5px 12px", fontSize: 11, fontWeight: 500, background: "#fff", border: "1px solid " + s.left, color: s.text, borderRadius: 6, cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0, fontFamily: "inherit" }}>
                                            {t("acknowledge")}
                                        </button>
                                    )}
                                </div>
            ...
            {done.length > 0 && (
                <div style={{ marginTop: 24 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                        <span style={{ fontSize: 11, fontWeight: 600, color: "#9aa5b4", textTransform: "uppercase", letterSpacing: 0.7 }}>{t("acknowledgedAlerts")}</span>
