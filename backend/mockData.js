// mockData.js — used ONLY for energy history chart and KPI generation
// Asset health now comes from SQL Server (sensor_readings table)
// Energy data still mocked until Sprint S2 MQTT listener is built

function rand(min, max) {
  return parseFloat((Math.random() * (max - min) + min).toFixed(1));
}

// Generates 24 hours of electricity history for the chart
