...
async function seed() {
    const users = [
        ...
        { email: "energy@dashboard.com",      password: "energu123" },
    ...
    sconsole.log("Please restart the server to apply changes.")
    process.exit(0);
}

seed().catch(err => { console.error("Seed ( Password Hashing ) failed:", err.message); process.exit(1); });
